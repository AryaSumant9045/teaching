        ...
        <div className="relative">
          ...
          >
            ...
            <div className="text-center px-8 pt-6 pb-4">
              ...
              <h1 className="text-4xl font-black tracking-tight text-white mt-1 mb-2">{t.beginPath}</h1>
              <p className="text-sm text-white/45 font-medium tracking-wide">{t.createAccount}</p>
            </div>
            ...
            <div className="px-8 pt-8 pb-7 flex flex-col gap-5">
              ...
              <motion.button
                ...
                className="w-full flex h-12 items-center justify-center gap-3 py-[22px] px-6 rounded-2xl font-semibold text-sm uppercase tracking-widest text-white transition-all duration-250 relative overflow-hidden group"
                style={{
              ...
              >
                ...
                <span className="z-10">{t.continueGoogle}</span>
              </motion.button>
              ...
              <motion.button
                ...
                className="w-full flex h-10 items-center justify-center gap-3 py-[22px] px-6 rounded-2xl font-semibold text-sm uppercase tracking-widest text-cyan-300 transition-all duration-250 group relative overflow-hidden"
                style={{
            ...
            <div className="px-8 pb-10 text-center">
              ...
              <p className="text-xs text-white/35 mb-1.5 font-medium tracking-wide">{t.alreadyStudent}</p>
              <p className="text-sm text-white/45">
                {t.readyReturn}{' '}
                <Link
                  href="/login"
                  className="text-orange-400 hover:text-orange-300 font-semibold hover:underline underline-offset-2 transition-colors duration-200"
                >
                  {t.signInAshrama}
                </Link>
              </p>
